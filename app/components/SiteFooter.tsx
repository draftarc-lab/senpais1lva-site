  ...
  return (
    <footer className="site-footer">
      <div className="container footer-main">
        ...
        <div className="footer-column"><span>Explore</span><Link href="/watch">Watch</Link><Link href="/recommendations">Recommendations</Link><Link href="/senpai-notes">Senpai Notes</Link><Link href="/about">About</Link></div>
